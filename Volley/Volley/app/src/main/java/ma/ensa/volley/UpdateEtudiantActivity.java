...
public class UpdateEtudiantActivity extends AppCompatActivity {
    ...
    private void updateEtudiant() {
        ...
        String updateUrl = "http://192.168.1.137:8087/api/student/"+ids;
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent intent = new Intent(UpdateEtudiantActivity.this, ListStudentActivity.class);
    ...
    private void fetchSpinnerOptionsFromAPI() {
        String Url = "http://192.168.1.137:8087/api/v1/filieres";
