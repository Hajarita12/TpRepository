...
public class ListRoleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAjouterRole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ListRoleActivity.this, MainActivity.class);
    ...
    private void deleteRole(final int position) {
        ...
        String url = "http://192.168.1.137:8087/api/v1/roles/" + roleId; // Remplacez ceci par l'URL de votre API pour supprimer une filière
