...
import ma.ensa.volley.FiliereAdapter;
...
public class ListFiliereActivity extends AppCompatActivity {
    ...
    private String loadUrl = "http://192.168.1.137:8087/api/v1/filieres";
    ...
    private void deleteFiliere(final int position) {
        ...
        String url = "http://192.168.1.137:8083/api/v1/filieres/" + filiereId; // Remplacez ceci par l'URL de votre API pour supprimer une filière
